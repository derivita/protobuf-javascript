...
goog.provide('proto.jspb.test.ExtensionMessage');
goog.provide('proto.jspb.test.ForeignNestedFieldMessage');
goog.provide('proto.jspb.test.TestExtensionsMessage');
goog.provide('proto.jspb.test.floatingMsgField');
goog.provide('proto.jspb.test.floatingStrField');
...
proto.jspb.test.ForeignNestedFieldMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
deeplyNestedMessage: (f = msg.getDeeplyNestedMessage()) && proto.jspb.test.Deeply.Nested.Message.toObject(includeInstance, f)
  };
...
proto.jspb.test.ForeignNestedFieldMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.jspb.test.Deeply.Nested.Message;
      reader.readMessage(value,proto.jspb.test.Deeply.Nested.Message.deserializeBinaryFromReader);
...
proto.jspb.test.ForeignNestedFieldMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.jspb.test.Deeply.Nested.Message.serializeBinaryToWriter
    );
  }
};
...
proto.jspb.test.ForeignNestedFieldMessage.prototype.getDeeplyNestedMessage = function() {
  return /** @type{?proto.jspb.test.Deeply.Nested.Message} */ (
    jspb.Message.getWrapperField(this, proto.jspb.test.Deeply.Nested.Message, 1));
};
